...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Spinner ChooseInputLan = (Spinner) findViewById(R.id.spinner1);
        Spinner ChooseOutputLan = (Spinner) findViewById(R.id.spinner2);


        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(TranslateActivity.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.InputLanguageCodes));
        myAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(TranslateActivity.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.OutputLanguageCodes));
        myAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        ChooseInputLan.setAdapter(myAdapter);
        ChooseOutputLan.setAdapter(myAdapter2);

        String InputLanguage = ChooseInputLan.getSelectedItem().toString();
        String OutputLanguage = ChooseOutputLan.getSelectedItem().toString();
    }
    ...
    public void translateText(View v) {
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang="+ InputLanguage +"-" + OutputLanguage + "&[format=plain]&[options=1]&[callback=set]";//The API service URL
